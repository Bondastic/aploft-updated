...
const ALMEN_LESSONS: Lesson[] = [
 ...
 icon: "saetningsled",
 points: [
 "Subjekt (grundled): hvem eller hvad udfører handlingen? Fx: 'Peter' løber",
 "Verballed (udsagnsled): selve det bøjede verbum i sætningen. Fx: Peter 'løber'",
 "Direkte objekt (genstandsled): hvem eller hvad rammes af handlingen? Fx: Peter spiser 'en kage'",
 "Indirekte objekt (hensynsled): til eller for hvem sker handlingen? Fx: Peter giver 'Mette' en bog",
 "Adverbial: fortæller om tid, sted, måde eller grad. Fx: Peter løber 'hurtigt' 'i parken'",
 "Subjektsprædikat: siger noget om subjektet. Fx: Peter er 'glad'",
 "Objektsprædikat: siger noget om det direkte objekt. Fx: De kalder hunden 'Fido'",
 ],
 },
 {
 ...
 headers: ["Sætningsled", "Latinsk kasus", "Spørgsmål", "Eksempel"],
 rows: [
 ["Subjekt", "Nominativ", "hvem/hvad + verbum?", "Puella cantat (pigen synger)"],
 ["Direkte objekt", "Akkusativ", "verbum + hvem/hvad?", "Puellam video (jeg ser pigen)"],
...
const HHX_LESSONS: Lesson[] = [
 ...
 icon: "saetningsled",
 points: [
 "Subjekt (grundled): hvem eller hvad udfører handlingen? Fx: 'Virksomheden' sender en faktura",
 "Verballed (udsagnsled): selve det bøjede verbum. Fx: Virksomheden 'sender' en faktura",
 ...
 icon: "morfologi",
 points: [
 "Morfem: den mindste del af et ord, der betyder noget, fx grundordet 'kund' eller endelsen '-e' i 'kunde'",
 ...
 icon: "tempus",
 points: [
 "Nutid (præsens): 'vi sender'. Datid (præteritum): 'vi sendte'",
 "Førnutid (perfektum): 'vi har sendt'. Førdatid (pluskvamperfektum): 'vi havde sendt'",
 "Fremtid (futurum): 'vi vil sende'",
 "De sammensatte tider dannes med hjælpeverbum + hovedverbet: har/havde/vil + sendt/sende",
 "I erhvervskommunikation er tid præcis: 'vi har sendt ordren' ≠ 'vi sender ordren'",
 "På engelsk: 'we send', 'we sent', 'we have sent', 'we had sent', 'we will send'",
 ],
 },
 {
 title: "Syntaks: sætningens orden",
 ...
 {
 title: "Semantik: læren om betydning",
 icon: "semantik",
 points: [
 "Udtryksside = ordets form (lyde/bogstaver). Indholdsside = ordets betydning",
