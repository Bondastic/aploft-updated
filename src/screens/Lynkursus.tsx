...
const HHX_LESSONS: Lesson[] = [
 ...
 icon: "saetningsled",
 points: [
 "Grundled (subjekt): hvem eller hvad udfører handlingen? Fx: 'Virksomheden' sender en faktura",
 "Udsagnsled: selve udsagnsordet. Fx: Virksomheden 'sender' en faktura",
 "Genstandsled (objekt): hvem eller hvad rammes af handlingen? Fx: Virksomheden sender 'en faktura'",
 "Hensynsled: til eller for hvem sker handlingen? Fx: Virksomheden sender 'kunden' en faktura",
...
export default function LynkursusPage({ education, progress }: { education: Education; progress: Progress }) {
 ...
 return (
    <div data-tour="lynkursus" className="mx-auto max-w-2xl space-y-6 px-4 pb-28 pt-4">
      <div>
