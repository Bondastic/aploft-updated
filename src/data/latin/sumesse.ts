...
export const SUMESSE_TASKS: Task[] = [
 ...
 mc("latin-sum-4", c, "'Est' er 3. person ental af 'esse'. Hvad betyder 'est'?", ["jeg er", "du er", "han/hun/den er", "I er"], 2, "'Est' = 'han/hun/den er'. Det er den mest brugte form, fordi de fleste latinske sætninger handler om en 'han/hun/den'.", ["1. person ental.", "2. person ental.", "", "2. person flertal."]),
 ...
 mc("latin-sum-35", c, "'Erat' er 3. person ental, datid, af 'esse'. Hvad betyder 'erat'?", ["han/hun/den var", "jeg var", "du var", "de var"], 0, "'Erat' = 'han/hun/den var' ; den mest brugte datidsform, ligesom 'est' er den mest brugte nutidsform.", ["", "1. person ental.", "2. person ental.", "3. person flertal."]),
