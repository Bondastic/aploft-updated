...
export const SUMESSE_TASKS: Task[] = [
 ...
 mc("latin-sum-4", c, "'Est' er 3. person ental af 'esse'. Hvad betyder 'est'?", ["jeg er (1. person ental)", "du er (2. person ental)", "han/hun/den er", "I er (2. person flertal)"], 2, "'Est' = 'han/hun/den er'. Det er den mest brugte form, fordi de fleste latinske sætninger handler om en 'han/hun/den'."),
 ...
 ["Remse dem højt i fast rækkefølge, ental først, så flertal", "Lære dem i en ny, tilfældig rækkefølge hver eneste gang", "Springe 'es' og 'estis' over, fordi de ligner hinanden", "Det er ikke nødvendigt at kunne dem udenad, når man skal til prøven"],
 0,
 ...
 mc("latin-sum-35", c, "'Erat' er 3. person ental, datid, af 'esse'. Hvad betyder 'erat'?", ["han/hun/den var", "jeg var (1. person ental)", "du var (2. person ental)", "de var (3. person flertal)"], 0, "'Erat' = 'han/hun/den var' ; den mest brugte datidsform, ligesom 'est' er den mest brugte nutidsform."),
 ...
 ["Hvilken person (jeg, du, han...) og hvilket tal verbet står i", "Hvilken kasus et navneord står i, fx nominativ eller akkusativ", "Om ordet er hankøn eller hunkøn", "Om sætningen er en helsætning eller en ledsætning i teksten"],
 0,
 ...
 ["At selv det uregelmæssige 'esse' bruger de samme genkendelige personendelser", "At 'esse' slet ikke følger huskereglen 'o/m, s, t, mus, tis, nt', men noget andet", "At 'esse' kun har tre former i alt, resten er usædvanlige", "At huskereglen kun gælder navneord, ikke verber"],
 0,
 ...
 ["-tis", "-s (2. person ental)", "-t (3. person ental)", "-nt (3. person flertal)"],
 0,
 ...
 ["Fordi den altid afslører, hvem der handler i en sætning, uanset verbum", "Fordi den kun virker på verbet 'esse', ikke på andre verber i latin", "Fordi den erstatter behovet for at kunne kasus og deklinationer", "Fordi den kun bruges i datid, ikke i nutid eller fremtid"],
 0,
