...
export const KOMMUNIKATION_TASKS: Task[] = [
 ...
 "Hensigtsmæssig kommunikation betyder netop, at sprogbrugen passer til situationen: en klage til en leverandør lyder anderledes end en tak til en kollega."
  ...
  mc("kommunikation-25", c, "En virksomhed svarer på en dårlig anmeldelse online. Hvem er modtageren?", ["Anmelderen og alle andre læsere", "Kun anmelderen selv", "Kun virksomhedens medarbejdere", "Kun platformens ejere"], 0, "Svaret er en offentlig tekst: Det henvender sig til anmelderen, men alle potentielle kunder kan læse det - derfor skal tonen være professionel.", ["", "Svaret står offentligt, så det læses også af kommende kunder.", "Medarbejderne er ikke målet med et offentligt svar.", "Platformens ejere er blot vært for teksten, ikke modtagere."]),
